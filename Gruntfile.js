	...
	grunt.initConfig({
		...
		config: {
			...
			dotfiles: {
				...
				path_templates: userhome('.dotfiles/templates'),
			},

			git: {
				path_gitconfig: userhome('.dotfiles/templates/.gitconfig'),
				path_gitconfig_system: userhome('.gitconfig'),
				path_gitignore_global: userhome('.dotfiles/templates/.gitignore_global'),
			...
			sublime_prefernces: {
				path_sublime_preferences: userhome('.sublime-preferences'),
			},

			oh_my_zsh: {
				path_oh_my_zsh: userhome('.oh-my-zsh'),
				path_plugin_git_prompt: userhome('.oh-my-zsh/custom/plugins/zsh-git-prompt'),
				path_plugin_syntax: userhome('.oh-my-zsh/custom/plugins/zsh-syntax-highlighting'),
			...
			zsh: {
				path_zshrc: userhome('.dotfiles/templates/.zshrc'),
		...
		gitclone: {
			...
			zsh_git_prompt: {
				options: {
					...
					repository: 'https://github.com/olivierverdier/zsh-git-prompt.git',
				},
			},
		...
		symlink: {
			...
			zsh_theme_dracula: {
                src: '<%= config.themes.path_dracula %>/zsh/dracula.zsh-theme'
                dest: '<%= config.oh_my_zsh.path_theme_dracula %>',
            },
